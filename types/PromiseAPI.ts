...
export class PromiseAccountsApi {
     ...
     */
    public listAccounts(ledger: string, pageSize?: number, pageSize2?: number, after?: string, address?: string, metadata?: any, balance?: number, balanceAsset?: string, balanceOperator?: 'gte' | 'lte' | 'gt' | 'lt' | 'e' | 'ne', balanceOperator2?: 'gte' | 'lte' | 'gt' | 'lt' | 'e' | 'ne', cursor?: string, paginationToken?: string, _options?: Configuration): Promise<AccountsCursorResponse> {
        const result = this.api.listAccounts(ledger, pageSize, pageSize2, after, address, metadata, balance, balanceAsset, balanceOperator, balanceOperator2, cursor, paginationToken, _options);
        return result.toPromise();
    }
...
export class PromiseLedgerApi {
     ...
     */
    public revertTransaction(ledger: string, txid: number, disableChecks?: boolean, _options?: Configuration): Promise<TransactionResponse> {
        const result = this.api.revertTransaction(ledger, txid, disableChecks, _options);
        return result.toPromise();
    }
