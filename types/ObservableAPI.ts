...
export class ObservableAccountsApi {
     ...
     */
    public listAccounts(ledger: string, pageSize?: number, pageSize2?: number, after?: string, address?: string, metadata?: any, balance?: number, balanceAsset?: string, balanceOperator?: 'gte' | 'lte' | 'gt' | 'lt' | 'e' | 'ne', balanceOperator2?: 'gte' | 'lte' | 'gt' | 'lt' | 'e' | 'ne', cursor?: string, paginationToken?: string, _options?: Configuration): Observable<AccountsCursorResponse> {
        const requestContextPromise = this.requestFactory.listAccounts(ledger, pageSize, pageSize2, after, address, metadata, balance, balanceAsset, balanceOperator, balanceOperator2, cursor, paginationToken, _options);
